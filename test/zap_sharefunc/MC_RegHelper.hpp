//---------------------------------------------------------------------------
#ifndef MC_RegHelperHPP
#define MC_RegHelperHPP
//---------------------------------------------------------------------------
...
public:
	...
	static bool Is64System(void)
	{
		...
		{
			fnIsWow64Process(GetCurrentProcess(),&tIsWow64);
		}
		return tIsWow64;
	}
	//---------------------------------------------------------------------------
	...
	//---------------------------------------------------------------------------
	static bool RegKeyAdd(char* vKeyPath, bool vVolatile)
	{
		HKEY tRootKey = RegKeyRoot(vKeyPath);
		if(0 == tRootKey)
		{
	...
	//---------------------------------------------------------------------------
	static int	RegKeySubKeyCount(char* vKeyPath)
	{
		HKEY tRootKey = RegKeyRoot(vKeyPath);
		if(0 == tRootKey)
			return 0;
	...
	//---------------------------------------------------------------------------
	static std::string RegKeySubKeyName(char* vKeyPath, int vIndex)
	{
	...
	//---------------------------------------------------------------------------
	static int RegValueCount(char* vKeyPath)
	{
		HKEY tRootKey = RegKeyRoot(vKeyPath);
		if(0 == tRootKey)
			return 0;
	...
	//---------------------------------------------------------------------------
	static std::string RegValueName(char* vKeyPath, int vIndex)
	{
		if(0 == vKeyPath)	return "";
		if(0 > vIndex)		return "";
	...
	//---------------------------------------------------------------------------
	static bool RegValueSet(char* vKeyPath, char* vValue, char* vData, int vType, int vSize)
	{
		if(0 == vData)
		{
			return false;
	...
	//---------------------------------------------------------------------------
	static bool RegValueSet(char* vKeyPath, char* vValue, DWORD vData)
	{
		HKEY tRootKey = RegKeyRoot(vKeyPath);
		if(0 == tRootKey)
			return false;
	...
	//---------------------------------------------------------------------------
	static std::string RegValueGet(char* vKeyPath, char* vValue)
	{
		HKEY tRootKey = RegKeyRoot(vKeyPath);
		if(0 == tRootKey)
			return "";
	...
	//---------------------------------------------------------------------------
	static bool RegValueDel(char* vKeyPath, char* vValue)
	{
		HKEY tRootKey = RegKeyRoot(vKeyPath);
		if(0 == tRootKey)
			return false;
