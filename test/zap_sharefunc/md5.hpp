...
a multiple of 4.
*/
inline void MD5::encode(const ulong *input, byte *output, size_t length) {
...
a multiple of 4.
*/
inline void MD5::decode(const byte *input, ulong *output, size_t length) {
...
inline std::string MD5::toString() {
